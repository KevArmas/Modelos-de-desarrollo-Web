...
#***Post
@router.post("/peliculasclass4/", response_model=Peliculas, status_code=status.HTTP_201_CREATED) #Añadir primer codigo de error correspondiente al metodo usando (Si es POST entonces usar POST)
async def peliculasclass(peliculas:Peliculas):
    ...
    #***Put
@router.put("/peliculasclass4/", response_model=Peliculas, status_code=status.HTTP_201_CREATED)
async def peliculasclass(peliculas:Peliculas):
    ...
    #http://127.0.0.1:8000/peliculasclass/
        ...
        #***Delete
@router.delete("/peliculasclass4/{id}", status_code=status.HTTP_204_NO_CONTENT)
